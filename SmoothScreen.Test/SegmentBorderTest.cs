...
//			var border2 = CreateBorder(LineVector.RightUnit, new Point(99, 0), 50);
...
//		{
//			var border1 = CreateBorder(LineVector.TopUnit, new Point(0, 0), 100);
//			var border2 = CreateBorder(LineVector.TopUnit, new Point(startX2, startY2), 10);
...
//		{
//			var border1 = CreateBorder(LineVector.TopUnit, new Point(startX1, startY1), length1);
//			var border2 = CreateBorder(LineVector.TopUnit, new Point(startX2, startY2), length2);
