...
//			borders = new[]
//			{
//				new Border(screener, LineVector.TopUnit, new Point(0, 0), 100),
//				new Border(screener, LineVector.RightUnit, new Point(99, 0), 100),
//				new Border(screener, LineVector.BottomUnit, new Point(99, 99), 100),
//				new Border(screener, LineVector.LeftUnit, new Point(0, 99), 100),
//			};
//		}
